...
\usepackage{amsmath}
\usepackage{lipsum}
\usepackage{indentfirst}%令第一段缩进
\usepackage{geometry}%
\begin{document}


\section{sty1.1}%公式中的间距（\!、\:、\;以及\quad 、\qquad，\,，{还可用于文本}）
...
\section{sty2.1}%段落缩进  \parskip段落垂直间距
\lipsum[1]
...
\section{sty3.1}%行文水平间距\hspace  垂直间距\vspace
x\hspace{1em}y\\
x\quad y\\
x\hspace{\stretch{1}}y\\
x\hspace{\fill}y
x\hspace{1.5cm}y
